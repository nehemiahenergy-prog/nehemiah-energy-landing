      ...
      <section style={{ background: `linear-gradient(175deg, ${C.dark} 0%, ${C.darkBg} 100%)`, padding: "clamp(80px,10vw,140px) 0", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, textAlign: "center" }}>
          ...
          <div className="grid grid-4-stats" style={{ maxWidth: 920, margin: "0 auto" }}>
            {[{ value: "24/7", label: "Hours Open" },{ value: "365", label: "Days a Year" },{ value: "2", label: "Charging Guns" },{ value: "30", suffix: "min", label: "To Full Charge" }].map((stat, i) => (
      ...
      <section id="stations" itemScope itemType="https://schema.org/EVChargingStation" style={{ background: C.light, padding: "clamp(80px,10vw,140px) 0" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <p className="body-lg" style={{ maxWidth: 640, margin: "0 auto" }}>{STATION_IS_OPEN ? "Nehemiah Gate is our flagship DC fast charging station, open 24 hours a day in Haatso, Greater Accra. Drop in any time, plug in, and we will have you back on the road in about 30 minutes." : "Nehemiah Gate, our flagship DC fast charging station in Haatso, Greater Accra, opens Monday, July 6, 2026. Once open, drop in any time — plug in and we will have you back on the road in about 30 minutes."}</p>
          </div>
          <div style={{ background: C.white, border: `1px solid ${C.border}`, borderRadius: 28, padding: "clamp(28px,4vw,48px)", maxWidth: 760, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 28 }}>
              {[{ icon: "pin", label: "Address", value: <span itemProp="address" itemScope itemType="https://schema.org/PostalAddress"><span itemProp="streetAddress">Haatso</span>, <span itemProp="addressLocality">Accra</span>, <span itemProp="addressRegion">Greater Accra</span>, <span itemProp="addressCountry">Ghana</span></span> },{ icon: "clock", label: "Hours", value: STATION_IS_OPEN ? "Open 24 hours · 7 days a week · 365 days a year" : "Opens Monday, July 6, 2026 · then 24 hours daily" },{ icon: "bolt", label: "Charging Power", value: "DC Fast Charging · 2 GBT connectors (Gun A & Gun B)"},{ icon: "smartphone", label: "Contact", value: <a href="tel:+233245947843" itemProp="telephone" style={{ color: C.dark }}>+233 24 594 7843</a> }].map((row, i) => (
          ...
          <div style={{ marginTop: 64 }}>
            <div style={{ textAlign: "center", marginBottom: 32 }}>
              ...
              <p className="body-lg" style={{ maxWidth: 560, margin: "0 auto" }}>Our DC fast chargers, the Neh Lounge, and the canopy that keeps you covered rain or shine.</p>
            </div>
