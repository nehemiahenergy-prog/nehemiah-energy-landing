  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Top: brand + columns */}
          <div className="neh-grid-footer" style={{ marginBottom: 64 }}>
            {/* Brand column */}
            <div>
              <div
                style={{
              ...
              >
                Powering Your Journey. Built by Ghanaians, for Ghanaians.
                Renewable energy solutions for the people who need them most.
              </p>
              {/* Social */}
            ...
            <div>
              ...
              >
                {["Find Stations", "Get the App", "Power Bikes", "For Fleets"].map(
                  (link) => (
                    <a key={link} href="#" className="neh-footer-link">
                      {link}
                    </a>
                  )
                )}
            ...
            <div>
              ...
              >
                <Link to="/about" className="neh-footer-link">About Us</Link>
                <a href="#" className="neh-footer-link">The Project</a>
                <a href="#" className="neh-footer-link">Contact</a>
                <a href="#" className="neh-footer-link">Careers</a>
              </div>
            </div>
          ...
          >
            <div style={{ fontSize: 12, color: "rgba(255,255,255,0.4)" }}>
              &copy; 2026 Nehemiah Energy Ltd. All rights reserved. Accra,
              Ghana.
            </div>
            <div
              style={{
