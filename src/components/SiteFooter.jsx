...
function SocialIcon({ kind, size = 18, color }) {
  const paths = {
    ...
    twitter: (
      <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z" stroke={color} strokeWidth="2" fill="none" strokeLinejoin="round" />
    ),
    facebook: (
      <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" stroke={color} strokeWidth="2" fill="none" strokeLinejoin="round" />
    ),
    linkedin: (
      <>
        <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-4 0v7h-4v-7a6 6 0 016-6z" stroke={color} strokeWidth="2" fill="none" strokeLinejoin="round" />
      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        <div className="grid grid-footer" style={{ marginBottom: 64 }}>
          ...
          <div>
            ...
            >
              Powering Your Journey. Built by Ghanaians, for Ghanaians. EV
              charging, charging wallet top-ups, and Power Bikes for the everyday
              Ghanaian driver.
            </p>
            <div style={{ display: "flex", gap: 10 }}>
              {SOCIALS.map((s) => (
                <a
                  key={s}
                  href="#"
                  aria-label={`Nehemiah Energy on ${s}`}
                  style={{
                    width: 40,
                    height: 40,
                    borderRadius: 10,
        ...
        >
          <div style={{ fontSize: 12, color: "rgba(255,255,255,0.4)" }}>
            &copy; 2026 Nehemiah Energy Ltd. All rights reserved. Accra, Ghana.
          </div>
          <div
            style={{
              fontSize: 11,
