...
const FAQS = [
  ...
  { q: "Is my electric vehicle compatible?", a: "Probably yes. We use the GB/T DC fast charging standard with two guns (Gun A and Gun B), which covers most EVs sold in Ghana including BYD, MG, JAC, Geely, and Great Wall. If you drive a CCS or CHAdeMO vehicle, send us your make and model and we will let you know." },
